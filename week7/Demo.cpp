...
void Demo::Render() {
	...
	float kursi_y = -0.2;
	float kursi_z = 1.5;	
	DrawColoredCube(glm::vec3(kursi_x + 0, kursi_y + 0.3, kursi_z + 0), glm::vec3(0, 1, 0), glm::vec3(1.3, 0.2, 1.3), 0, false, (float)92 / 255, (float)50 / 255, (float)23 / 255);
	DrawColoredCube(glm::vec3(kursi_x + 0, kursi_y + 0.3+0.75+0.1, kursi_z + 0.65-0.1), glm::vec3(0, 1, 0), glm::vec3(1.3, 1.5, 0.2), 0, false, (float)92 / 255, (float)50 / 255, (float)23 / 255);

	DrawColoredCube(glm::vec3(kursi_x + (-0.6), kursi_y + 0, kursi_z + (0.6)), glm::vec3(0, 0, 0), glm::vec3(0.1, 0.6, 0.1), 0, false, (float)92 / 255, (float)50 / 255, (float)23 / 255);
	DrawColoredCube(glm::vec3(kursi_x + (0.6), kursi_y + 0, kursi_z + (-0.6)), glm::vec3(0, 0, 0), glm::vec3(0.1, 0.6, 0.1), 0, false, (float)92 / 255, (float)50 / 255, (float)23 / 255);
	DrawColoredCube(glm::vec3(kursi_x + (-0.6), kursi_y + 0, kursi_z + (-0.6)), glm::vec3(0, 0, 0), glm::vec3(0.1, 0.6, 0.1), 0, false, (float)92 / 255, (float)50 / 255, (float)23 / 255);
	DrawColoredCube(glm::vec3(kursi_x + (0.6), kursi_y + 0, kursi_z + (0.6)), glm::vec3(0, 0, 0), glm::vec3(0.1, 0.6, 0.1), 0, false, (float)92 / 255, (float)50 / 255, (float)23 / 255);
